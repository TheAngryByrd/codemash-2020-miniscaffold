...
let gitProjectName = "codemash-2020-miniscaffold"
...
let copyJavascript() =
    try
        CopyFile (outDir </> "js" </> "custom.js") (slidesDir </> "custom.js")
    with
    | exn -> traceImportant <| sprintf "Could not copy javascript: %s" exn.Message
